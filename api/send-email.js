...
<body class="em-hero" style="margin:0;padding:0;background-color:${G_DEEP} !important;color-scheme:light" bgcolor="${G_DEEP}">

<table width="100%" cellpadding="0" cellspacing="0" role="presentation"
  bgcolor="${G_DEEP}" style="background-color:${G_DEEP} !important">
<tr><td align="center" bgcolor="${G_DEEP}" style="background-color:${G_DEEP} !important">
  ...
  <table width="600" cellpadding="0" cellspacing="0" role="presentation"
    ...
    <tr><td height="4" bgcolor="${GOLD}" class="em-gold"
      style="background-color:${GOLD} !important;font-size:0;line-height:0">&nbsp;</td></tr>

    <!-- ── HERO ── -->
    <tr><td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;padding:0">
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td width="4" bgcolor="${GOLD}" class="em-gold" style="background-color:${GOLD} !important;font-size:0">&nbsp;</td>
          <td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;padding:48px 44px 0">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td width="4" bgcolor="${GOLD}" class="em-gold" style="background-color:${GOLD} !important;font-size:0">&nbsp;</td>
          <td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;padding:28px 44px 0">
            <table cellpadding="0" cellspacing="0" role="presentation">
              <tr>
                <td width="48" height="1" bgcolor="${GOLD}" style="background-color:${GOLD} !important;font-size:0;line-height:0">&nbsp;</td>
                <td width="10">&nbsp;</td>
                <td width="24" height="1" bgcolor="${G_PILL}" style="background-color:${G_PILL} !important;font-size:0;line-height:0">&nbsp;</td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td width="4" bgcolor="${GOLD}" class="em-gold" style="background-color:${GOLD} !important;font-size:0">&nbsp;</td>
          <td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;padding:24px 44px 48px">
            <table cellpadding="0" cellspacing="0" role="presentation">
              <tr>
    ...
    <!-- ── PROMISE BAND ── -->
    <tr><td bgcolor="${GOLD}" class="em-gold" style="background-color:${GOLD} !important;padding:16px 48px">
    ...
    <tr><td bgcolor="${PAPER}" class="em-paper" style="background-color:${PAPER};padding:48px 44px 40px">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-top:32px">
        <tr><td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;border-radius:8px;padding:18px 22px">
    ...
    <!-- ── FOOTER ── -->
    <tr><td bgcolor="${G_DEEP}" class="em-hero" style="background-color:${G_DEEP} !important;padding:22px 44px;text-align:center">
...
<tr><td align="center" bgcolor="${G_DEEP}" style="background-color:${G_DEEP} !important">
  ...
  <table width="600" cellpadding="0" cellspacing="0" role="presentation"
    ...
    <!-- ── HEADER ── -->
    <tr><td bgcolor="${G_MID}" class="em-panel" style="background-color:${G_MID} !important;padding:0">
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
          <td width="4" bgcolor="${GOLD}" class="em-gold" style="background-color:${GOLD} !important;font-size:0">&nbsp;</td>
          <td bgcolor="${G_MID}" class="em-panel" style="background-color:${G_MID} !important;padding:34px 44px">
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" style="margin-top:16px">
              <tr><td bgcolor="${G_PILL}" style="background-color:${G_PILL} !important;border:1px solid ${GOLD};border-radius:100px;padding:6px 18px">
    ...
    <tr><td bgcolor="${PAPER}" class="em-paper" style="background-color:${PAPER};padding:0">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td width="3" bgcolor="${GOLD}" class="em-gold"
                style="background-color:${GOLD} !important;font-size:0">&nbsp;</td>
    ...
    <tr><td bgcolor="${WARM}" class="em-warm"
      ...
      <a href="mailto:${email}?subject=Re%3A%20Your%20Iyadi%20Planning%20Solutions%20Enquiry&body=Dear%20${encodeURIComponent(name)}%2C%0A%0AThank%20you%20for%20your%20interest."
        style="display:inline-block;background-color:${G_MID} !important;color:#fff;
    ...
    <tr><td bgcolor="${G_DEEP}" class="em-hero"
      style="background-color:${G_DEEP} !important;padding:22px 44px;text-align:center">
